...
import logo2 from "../../assets/lc-logo.png";
import logo3 from "../../assets/lc-logo2.png";
        ...
        <div>
          <a href="/">
            <img
              src={logo3}
              alt="Telerivet Logo"
              className="w-45 sm:h-12 md:h-5 lg:h-12"
            />
          </a>
        </div>
        ...
        <nav className="hidden md:block">
          <ul className="flex items-center space-x-6">
            {[
              {
                name: "Product",
                href: "https://www.telerivet.com/product/platform",
              },
              // { name: "Pricing", href: "#pricing" },
              {
                name: "Guide",
                href: "https://guide.telerivet.com/hc/en-us?hsLang=en",
              },
            ...
            {isRootPath && (
              <>
                <li>
                  <a
                    href="https://telerivet.com/login?hsLang=en"
                    className="px-4 py-2 text-primary hover:text-primary sm:text-sm lg:text-tiny"
                  >
                    Sign In
                  </a>
                </li>
                <li>
                  <button
                    ...
                    className="rounded-xl border-2 border-primary px-4 py-4 text-white transition duration-300 hover:bg-primary sm:text-sm lg:text-tiny"
                  >
          ...
          <Drawer.Items>
            <ul className="space-y-4">
              {[
                ...
                {
                  name: "Solution",
                  href: "https://www.telerivet.com/solutions",
                },
                { name: "About", href: "https://www.telerivet.com/about" },
              ].map((item) => (
                <li key={item.name}>
